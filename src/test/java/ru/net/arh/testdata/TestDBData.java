...
public class TestDBData {
    ...
    public static final Map<Restaurant, List<MenuItem>> PRICES = new HashMap<>();
    ...
    public static final MenuItem MENU_ITEM_1 = new MenuItem(NEXT_ID++, RESTAURANT1, DISH2, LocalDate.now(), 10.11);
    public static final MenuItem MENU_ITEM_2 = new MenuItem(NEXT_ID++, RESTAURANT1, DISH3, LocalDate.now(), 10.12);
    public static final MenuItem MENU_ITEM_3 = new MenuItem(NEXT_ID++, RESTAURANT1, DISH4, LocalDate.now(), 10.13);
    public static final MenuItem MENU_ITEM_4 = new MenuItem(NEXT_ID++, RESTAURANT2, DISH1, LocalDate.now(), 12.00);
    public static final MenuItem MENU_ITEM_5 = new MenuItem(NEXT_ID++, RESTAURANT2, DISH2, LocalDate.now(), 14.00);
    public static final MenuItem MENU_ITEM_6 = new MenuItem(NEXT_ID++, RESTAURANT2, DISH4, LocalDate.now(), 16.00);
    public static final int START_YESTERDAY_PRICE_ID = NEXT_ID;
    public static final MenuItem MENU_ITEM_7 = new MenuItem(NEXT_ID++, RESTAURANT1, DISH1, LocalDate.now().minusDays(1), 10.00);
    public static final MenuItem MENU_ITEM_8 = new MenuItem(NEXT_ID++, RESTAURANT1, DISH2, LocalDate.now().minusDays(1), 11.00);
    public static final MenuItem MENU_ITEM_9 = new MenuItem(NEXT_ID++, RESTAURANT1, DISH3, LocalDate.now().minusDays(1), 12.00);
    public static final MenuItem MENU_ITEM_10 = new MenuItem(NEXT_ID++, RESTAURANT2, DISH1, LocalDate.now().minusDays(1), 10.00);
    public static final MenuItem MENU_ITEM_11 = new MenuItem(NEXT_ID++, RESTAURANT2, DISH4, LocalDate.now().minusDays(1), 11.00);
